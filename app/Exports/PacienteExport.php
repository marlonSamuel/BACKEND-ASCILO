...
class PacienteExport implements FromCollection, WithEvents, ShouldAutoSize,  WithCustomStartCell, WithColumnFormatting, WithTitle, WithDrawings,WithHeadings
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->setCellValue('C2', mb_strtoupper('REPORTE DE PACIENTES, ASCILO BUENA VISTA', 'UTF-8'));
                ...
                $event->sheet->getStyle('A10:R10')->applyFromArray($styleHeadings);
                $event->sheet->setAutoFilter('A10:R10');
