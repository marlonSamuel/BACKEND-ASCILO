...
class PagosFundacionExport implements FromCollection, WithEvents, ShouldAutoSize,  WithCustomStartCell, WithColumnFormatting, WithTitle, WithDrawings,WithHeadings
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->setCellValue('C2', mb_strtoupper('REPORTE DE PAGOS A FUNDACIÓN, ASCILO BUENA VISTA', 'UTF-8'));
                ...
                $event->sheet->getStyle('AI:R8')->applyFromArray($styleHeaderArray);//title header
