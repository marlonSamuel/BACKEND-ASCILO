...
class ExamenesExport implements FromCollection, WithEvents, ShouldAutoSize,  WithCustomStartCell, WithColumnFormatting, WithTitle, WithDrawings,WithHeadings
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->setCellValue('C2', mb_strtoupper('REPORTE DE EXAMENES A PACIENTES POR CONSULTAS, ASCILO BUENA VISTA', 'UTF-8'));
                ...
                $event->sheet->getStyle('A1:G8')->applyFromArray($styleHeaderArray);//title header

                $event->sheet->getStyle('A10:G10')->applyFromArray($styleHeadings);
                $event->sheet->setAutoFilter('A10:G10');
